...
import com.osprey.core.extension.px
import com.osprey.core.extension.screenSize
    ...
    private fun setupRecyclerView() {
        viewBinding().apply {
            menuRecyclerView.apply {
                adapter = MenuOptionAdapter(object :
                    MenuOptionListener {
    ...
    companion object {
        fun show(
            ...
            val popupWindow = PopupWindow(
                ...
                elevation = context.resources.getDimension(com.osprey.core.R.dimen.dp_16)
